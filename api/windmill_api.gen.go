...
const (
	JobTypeCompletedJob JobType = "CompletedJob"
	JobTypeQueuedJob    JobType = "QueuedJob"
)

// Defines values for MainArgSignatureArgsTyp0.
const (
	Bool     MainArgSignatureArgsTyp0 = "bool"
	Bytes    MainArgSignatureArgsTyp0 = "bytes"
	Datetime MainArgSignatureArgsTyp0 = "datetime"
	Dict     MainArgSignatureArgsTyp0 = "dict"
	Email    MainArgSignatureArgsTyp0 = "email"
	Float    MainArgSignatureArgsTyp0 = "float"
	Int      MainArgSignatureArgsTyp0 = "int"
	Sql      MainArgSignatureArgsTyp0 = "sql"
	Unknown  MainArgSignatureArgsTyp0 = "unknown"
)
...
const (
	Create  ListAuditLogsParamsActionKind = "Create"
	Delete  ListAuditLogsParamsActionKind = "Delete"
	Execute ListAuditLogsParamsActionKind = "Execute"
	Update  ListAuditLogsParamsActionKind = "Update"
)

// Defines values for CreateScriptJSONBodyKind.
const (
	CreateScriptJSONBodyKindApproval CreateScriptJSONBodyKind = "approval"
	CreateScriptJSONBodyKindCommand  CreateScriptJSONBodyKind = "command"
	CreateScriptJSONBodyKindFailure  CreateScriptJSONBodyKind = "failure"
	CreateScriptJSONBodyKindScript   CreateScriptJSONBodyKind = "script"
	CreateScriptJSONBodyKindTrigger  CreateScriptJSONBodyKind = "trigger"
)

// Defines values for CreateScriptJSONBodyLanguage.
const (
	CreateScriptJSONBodyLanguageDeno    CreateScriptJSONBodyLanguage = "deno"
	CreateScriptJSONBodyLanguageGo      CreateScriptJSONBodyLanguage = "go"
	CreateScriptJSONBodyLanguagePython3 CreateScriptJSONBodyLanguage = "python3"
)
...
type MainArgSignature struct {
	Args []struct {
		...
		Name       string                    `json:"name"`
		Typ        MainArgSignature_Args_Typ `json:"typ"`
	} `json:"args"`
	StarArgs   bool  `json:"star_args"`
	StarKwargs *bool `json:"star_kwargs,omitempty"`
}

// MainArgSignatureArgsTyp0 defines model for .
type MainArgSignatureArgsTyp0 MainArgSignatureArgsTyp

// MainArgSignatureArgsTyp1 defines model for .
type MainArgSignatureArgsTyp1 struct {
	Resource *string `json:"resource"`
}

// MainArgSignatureArgsTyp2 defines model for .
type MainArgSignatureArgsTyp2 struct {
	Str *[]string `json:"str"`
}

// MainArgSignatureArgsTyp3 defines model for .
type MainArgSignatureArgsTyp3 struct {
	Object []struct {
		Key string                               `json:"key"`
		Typ MainArgSignature_Args_Typ_Object_Typ `json:"typ"`
	} `json:"object"`
}

// MainArgSignatureArgsTyp4 defines model for .
type MainArgSignatureArgsTyp4 struct {
	List *MainArgSignature_Args_Typ_List `json:"list"`
}

// MainArgSignature_Args_Typ defines model for MainArgSignature.Args.Typ.
type MainArgSignature_Args_Typ struct {
	union json.RawMessage
}
...
type ListAuditLogsParams struct {
	...
	// Before filter on created before (exclusive) timestamp
...
type ResultByIdParams struct {
	// SkipDirect Skip checking that the node is part of the given flow.
...
type ListResourceParams struct {
	...
	// ResourceType resource_type to list from
...
type CreateFlowJSONRequestBody = OpenFlowWPath

// UpdateFlowJSONRequestBody defines body for UpdateFlow for application/json ContentType.
type UpdateFlowJSONRequestBody = OpenFlowWPath
...
type SetWorkspaceSlackJSONRequestBody = SlackToken
...
// AsCompletedJob returns the union data inside the Job as a CompletedJob
func (t Job) AsCompletedJob() (CompletedJob, error) {
	var body CompletedJob
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromCompletedJob overwrites any union data inside the Job as the provided CompletedJob
func (t *Job) FromCompletedJob(v CompletedJob) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeCompletedJob performs a merge with any union data inside the Job, using the provided CompletedJob
func (t *Job) MergeCompletedJob(v CompletedJob) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsQueuedJob returns the union data inside the Job as a QueuedJob
func (t Job) AsQueuedJob() (QueuedJob, error) {
	var body QueuedJob
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromQueuedJob overwrites any union data inside the Job as the provided QueuedJob
func (t *Job) FromQueuedJob(v QueuedJob) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeQueuedJob performs a merge with any union data inside the Job, using the provided QueuedJob
func (t *Job) MergeQueuedJob(v QueuedJob) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsMainArgSignatureArgsTyp0 returns the union data inside the MainArgSignature_Args_Typ as a MainArgSignatureArgsTyp0
func (t MainArgSignature_Args_Typ) AsMainArgSignatureArgsTyp0() (MainArgSignatureArgsTyp0, error) {
	var body MainArgSignatureArgsTyp0
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromMainArgSignatureArgsTyp0 overwrites any union data inside the MainArgSignature_Args_Typ as the provided MainArgSignatureArgsTyp0
func (t *MainArgSignature_Args_Typ) FromMainArgSignatureArgsTyp0(v MainArgSignatureArgsTyp0) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeMainArgSignatureArgsTyp0 performs a merge with any union data inside the MainArgSignature_Args_Typ, using the provided MainArgSignatureArgsTyp0
func (t *MainArgSignature_Args_Typ) MergeMainArgSignatureArgsTyp0(v MainArgSignatureArgsTyp0) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsMainArgSignatureArgsTyp1 returns the union data inside the MainArgSignature_Args_Typ as a MainArgSignatureArgsTyp1
func (t MainArgSignature_Args_Typ) AsMainArgSignatureArgsTyp1() (MainArgSignatureArgsTyp1, error) {
	var body MainArgSignatureArgsTyp1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromMainArgSignatureArgsTyp1 overwrites any union data inside the MainArgSignature_Args_Typ as the provided MainArgSignatureArgsTyp1
func (t *MainArgSignature_Args_Typ) FromMainArgSignatureArgsTyp1(v MainArgSignatureArgsTyp1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeMainArgSignatureArgsTyp1 performs a merge with any union data inside the MainArgSignature_Args_Typ, using the provided MainArgSignatureArgsTyp1
func (t *MainArgSignature_Args_Typ) MergeMainArgSignatureArgsTyp1(v MainArgSignatureArgsTyp1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsMainArgSignatureArgsTyp2 returns the union data inside the MainArgSignature_Args_Typ as a MainArgSignatureArgsTyp2
func (t MainArgSignature_Args_Typ) AsMainArgSignatureArgsTyp2() (MainArgSignatureArgsTyp2, error) {
	var body MainArgSignatureArgsTyp2
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromMainArgSignatureArgsTyp2 overwrites any union data inside the MainArgSignature_Args_Typ as the provided MainArgSignatureArgsTyp2
func (t *MainArgSignature_Args_Typ) FromMainArgSignatureArgsTyp2(v MainArgSignatureArgsTyp2) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeMainArgSignatureArgsTyp2 performs a merge with any union data inside the MainArgSignature_Args_Typ, using the provided MainArgSignatureArgsTyp2
func (t *MainArgSignature_Args_Typ) MergeMainArgSignatureArgsTyp2(v MainArgSignatureArgsTyp2) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsMainArgSignatureArgsTyp3 returns the union data inside the MainArgSignature_Args_Typ as a MainArgSignatureArgsTyp3
func (t MainArgSignature_Args_Typ) AsMainArgSignatureArgsTyp3() (MainArgSignatureArgsTyp3, error) {
	var body MainArgSignatureArgsTyp3
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromMainArgSignatureArgsTyp3 overwrites any union data inside the MainArgSignature_Args_Typ as the provided MainArgSignatureArgsTyp3
func (t *MainArgSignature_Args_Typ) FromMainArgSignatureArgsTyp3(v MainArgSignatureArgsTyp3) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeMainArgSignatureArgsTyp3 performs a merge with any union data inside the MainArgSignature_Args_Typ, using the provided MainArgSignatureArgsTyp3
func (t *MainArgSignature_Args_Typ) MergeMainArgSignatureArgsTyp3(v MainArgSignatureArgsTyp3) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsMainArgSignatureArgsTyp4 returns the union data inside the MainArgSignature_Args_Typ as a MainArgSignatureArgsTyp4
func (t MainArgSignature_Args_Typ) AsMainArgSignatureArgsTyp4() (MainArgSignatureArgsTyp4, error) {
	var body MainArgSignatureArgsTyp4
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromMainArgSignatureArgsTyp4 overwrites any union data inside the MainArgSignature_Args_Typ as the provided MainArgSignatureArgsTyp4
func (t *MainArgSignature_Args_Typ) FromMainArgSignatureArgsTyp4(v MainArgSignatureArgsTyp4) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeMainArgSignatureArgsTyp4 performs a merge with any union data inside the MainArgSignature_Args_Typ, using the provided MainArgSignatureArgsTyp4
func (t *MainArgSignature_Args_Typ) MergeMainArgSignatureArgsTyp4(v MainArgSignatureArgsTyp4) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t MainArgSignature_Args_Typ) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *MainArgSignature_Args_Typ) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
